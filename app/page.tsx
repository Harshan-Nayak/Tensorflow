...
import { FlipHorizontal, Camera, Video, PersonStanding, Volume2, SunIcon, MoonIcon } from "lucide-react";
  ...
  return (
    ...
    <div className="flex h-screen" >
      ...
      {loading && <div className="z-50 absolute w-full h-full flex items-center justify-center bg-primary-foreground " >
        Getting Things Ready . . . <Rings height={50} color='red' /><br />
        <br />
        <p>Have Patience, This is developed by So Much of Hard Work🫡</p>
      </div>}
    </div>
